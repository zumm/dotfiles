...
// Disable translation engine
user_pref("browser.translation.engine", "");

// Disable connections to Mozilla servers
user_pref("services.settings.server", "");

// Return https prefix back
user_pref("browser.urlbar.trimHttps", false);

// Enforce no DoH, needed for sing-box to work without sniffing
user_pref("network.trr.mode", 5);

// Restore previous session on startup
user_pref("browser.startup.page", 3);

// Disable menu opening when holding down Alt key
